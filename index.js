...
// Your code here...
let string = "Batman";
const stringThree = string3.repeat(3);
const final = (stringThree+ " " + string);
console.log(final);
...
if (funnyHeadline1.includes("oxygen")){console.log ("The string includes the word 'oxygen'")}
